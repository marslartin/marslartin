...
function CookieConsent(props) {
    ...
    self.props = {
        ...
        privacyPolicyUrl: "personvern.html",
        autoShowModal: true, // disable autoShowModal on the privacy policy page, to make that page readable
        blockAccess: false, // set "true" to block the access to the website before choosing a cookie configuration
        position: "right", // position ("left" or "right"), if blockAccess is false
        postSelectionCallback: undefined, // callback, after the user has made his selection
        lang: navigator.language, // the language, in which the dialog is shown
        defaultLang: "no", // default language, if the `lang` is not available as translation in `content`
        content: { // the content in all needed languages
            no: {
                title: "Innstillinger for informasjonskapsler",
                body: "Denne siden bruker ingen tredjeparts informasjonskapsler for sporing eller analyse. " +
                    "Du kan velge om du vil tillate kun de teknisk nødvendige informasjonskapslene, eller om du også aksepterer " +
                    "eventuell bruk av informasjonskapsler for sporing og analyse. Les mer her: --privacy-policy--.",
                privacyPolicy: "personvernerklæring",
                buttonAcceptAll: "Aksepter bruk av informasjonskapsler",
                buttonAcceptTechnical: "Aksepter kun teknisk nødvendige informasjonskapsler"
            },
            en: {
